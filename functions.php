...
function theme_enqueue_scripts() {
  // Enqueue your other scripts as needed
  wp_enqueue_script('combined-scripts', get_template_directory_uri() . '/src/js/combined-scripts.js', array('jquery'), null, true);
}
add_action('wp_enqueue_scripts', 'theme_enqueue_scripts');
function my_theme_enqueue_styles() {
  wp_enqueue_style('style', get_stylesheet_directory_uri() . '/src/css/style.css');
}

...
<div class="blogImageAndContentSection">
  <h2>أفضل قرى سيدي عبد الرحمن sidi abdel Rahman الساحل الشمالي</h2>
  ...
  <div class="socialMediaShare">
    <?php get_template_part('template-parts/global/author-date') ?>
  ...
  <p>أعلنت الهيئة العامة للاعتماد والرقابة الصحية، برئاسة الدكتور أحمد طه، إطلاق الوثيقة والخريطة الاستراتيجية للهيئة حتى نهاية عام 2026، والتي تعكس الإطار العام لاستراتيجية الهيئة الوطنية لتطبيق الجودة، والرؤية المستقبلية لخطتها الاستراتيجية بما تضمه من مرتكزات، وغايات، وأهداف استراتيجية.

    وصرح الدكتور أحمد طه، رئيس هيئة الاعتماد والرقابة الصحية، بأن الاستراتيجية تمثل خارطة طريق مستقبلية لتوجيه الأولويات والأهداف والخطط العملية للهيئة خلال 3 سنوات مقبلة بما يساعد في تحسين الأداء وزيادة الكفاءة والفعالية في مواجهة التحديات، كما يحدد رؤية واضحة تعكسها محاور وأولويات الخطة الاستراتيجية للهيئة وضروريات العمل، وهو ما يتسق مع أساليب إدارة القطاعات الصحية بالدول الأكثر تميزاً في مستويات جودة الخدمات الصحية.</p>

<?php get_template_part('template-parts/blog-content-page/related-news-incontent') ?>
  ...
  <div class="copyTheUrl">
    <div class="copyTheUrlContent">
      ...
      <span><?php _e('Copy the article link', 'veelinvestments'); ?></span></span>

...
<script>
  ...
  const veelMobilenavbar = document.getElementById('veelMobilenavbar');
  const xMark = document.getElementById('xMark');

  if (humburgerMenu && veelMobilenavbar && xMark) {
    humburgerMenu.addEventListener('click', function () {
      // Check if the navbar is hidden (style display is 'none' or empty)
      if (veelMobilenavbar.style.display === 'none' || veelMobilenavbar.style.display === '') {
        veelMobilenavbar.style.display = 'flex';
        veelMobilenavbar.style.position = 'fixed';
      } else {
        veelMobilenavbar.style.display = 'none';
      }
    });

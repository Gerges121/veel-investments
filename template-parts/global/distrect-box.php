...
<div class="districtBox">
  <div class="districtBoxImg">
    <div class="districtBoxImgIcon">
  ...
  <div class="districtBoxNameandCta">
    <p>ديستريكت 5</p>
    <div class="districtBoxPhoneWa">
      <?php get_template_part('template-parts/front-page/cta'); ?>
    </div>

  </div>
  <div class="districtBoxAddress">
  ...
  <div class="districtBoxPrice">
    <div class="districtPrice">
      <div class="districtsPrice"> <?php _e('Price', 'veelinvestments'); ?></div>
      <div class="districtPriceNumber">11,292,000</div>
    </div>
    <div class="districtPriceStart"><?php _e('Deposit', 'veelinvestments'); ?>   1,129,200 /7 سنوات</div>
  </div>

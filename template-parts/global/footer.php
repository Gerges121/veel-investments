...
<div class="veelFooter">
  ...
  <div class="logoandSocial">
    <div class="logo"><img src="<?php echo get_template_directory_uri(); ?>/src/img/veel-footer-logo.webp"></div>

    <div class="social"> <?php get_template_part('template-parts/front-page/social');
      ?> </div>
  </div>

  <div class="quickLinks">
    <div class="quickLinksHeader" id="quickLinksHeader"> <?php _e('Quick Links', 'veelinvestments'); ?><svg xmlns="http://www.w3.org/2000/svg" width="29" height="29" viewBox="0 0 29 29" fill="none">
    ...
    <div class="quickLinksList" id="quickLinksList">
<!--      <ul>-->
...
<!--      </ul>-->
      ...
      wp_nav_menu(array(
        ...
        'menu_class' => 'nav-menu',
        'fallback_cb' => false,
        'depth' => 1, // Adjust depth for submenu levels
      ));
      ?>
  ...
  <div class="contactUs">
    <div class="cntactUsHeader" id="cntactUsHeader"><?php _e('Contact Us', 'veelinvestments'); ?> <svg xmlns="http://www.w3.org/2000/svg" width="29" height="29" viewBox="0 0 29 29" fill="none">
      <path d="M14.0604 13.352L8.07919 19.3333L6.37061 17.6247L14.0604 9.93484L21.7503 17.6247L20.0417 19.3333L14.0604 13.352Z" fill="white"/>
    </svg></div>
    <div class="veelPhoneCall" id="veelPhoneCall">
    ...
    <div class="veelGmailContent" id="veelGmailContent">
